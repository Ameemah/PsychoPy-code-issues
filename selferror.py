...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\khana\\Documents\\PsychoPy Tests\\allconditions1loop.py',
...
for thisLoop10 in Loop10:
    ...
    while continueRoutine and routineTimer.getTime() < 20.0:
        ...
        if endExpNow or defaultKeyboard.getKeys('self'(keyList=["escape"])):
            core.quit()
